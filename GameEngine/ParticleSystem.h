...
#define GAMEENGINE_ParticleSystem __declspec(dllexport)
#else
#define GAMEENGINE_ParticleSystem __declspec(dllimport)
#endif
#include <SDL.h>
#include <vector>
#include <string>

struct GAMEENGINE_ParticleSystem Pointf
{
public:
    Pointf() {}
...
struct GAMEENGINE_ParticleSystem Color4F
{
    float r = 0, g = 0, b = 0, a = 0;
};

class GAMEENGINE_ParticleSystem ParticleData
{
public:
    float posx = 0;
    float posy = 0;
...
class GAMEENGINE_ParticleSystem ParticleSystem
{
public:
    enum class Mode
    {
