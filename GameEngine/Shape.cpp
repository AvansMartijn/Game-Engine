...
void Shape::SetOrient(real radians)
{
    u.Set(radians);
}

void Shape::ComputeMass(real density)
{
...
void Shape::SetBox(real hw, real hh)
{
    m_vertexCount = 4;
...
void Shape::Set(Vec2* vertices, uint32 count)
{
...
int Shape::getWidthFromVertice()
{
    return (int)m_vertices[2].x * 2;
}

int Shape::getHeightFromVertice()
{
    return (int)m_vertices[2].y * 2;
}
