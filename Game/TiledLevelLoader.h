...
public:
	...
	TiledLevel getTiledLevel(const std::string& name);
	...
	std::vector<TiledGameObject> getTiledGameObjects(const TiledLevel& tiledLevel);
	...
	TiledTileSet findTileSetForGid(const TiledLevel& level, int gid) const;
	...
	TiledTile findTileForGid(const TiledTileSet& tileSet, int gid) const;
};