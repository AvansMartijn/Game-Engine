...
void PauseScreen::onInit() {
	...
	ButtonUiElement helpButton = ButtonUiElement("Help", { (1080 / 2) - 200, 250, 500, 100 }, bgColor, { 180, 102, 13 }, "Portal", 40);
	...
	ButtonUiElement RestartButton = ButtonUiElement("Restart", { (1080 / 2) - 200, 400, 500, 100 }, bgColor, { 180, 102, 13 }, "Portal", 40);
